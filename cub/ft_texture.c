...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/18 16:43:43 by acharras          #+#    #+#             */
/*   Updated: 2020/02/28 14:09:16 by acharras         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "ft_cub3d.h"

static void	ft_texture_no(t_cub3d *game)
{
	if (game->side == 1)
	...
	game->tex_x = (int)(game->wallx * (double)game->no_width);
...
static void	ft_texture_so(t_cub3d *game)
{
	if (game->side == 1)
		game->wallx = game->posy + game->perspwalldist * game->raydiry;
	else
		game->wallx = game->posx + game->perspwalldist * game->raydirx;
	game->wallx -= floor((game->wallx));
	game->tex_x = (int)(game->wallx * (double)game->so_width);
	if (game->side == 0 && game->raydiry > 0)
...
static void	ft_texture_we(t_cub3d *game)
{
	if (game->side == 1)
		game->wallx = game->posy + game->perspwalldist * game->raydiry;
	else
		game->wallx = game->posx + game->perspwalldist * game->raydirx;
	game->wallx -= floor((game->wallx));
	game->tex_x = (int)(game->wallx * (double)game->we_width);
	if (game->side == 0 && game->raydiry > 0)
...
static void	ft_texture_ea(t_cub3d *game)
{
	if (game->side == 1)
		game->wallx = game->posy + game->perspwalldist * game->raydiry;
	else
		game->wallx = game->posx + game->perspwalldist * game->raydirx;
	game->wallx -= floor((game->wallx));
	game->tex_x = (int)(game->wallx * (double)game->ea_width);
	if (game->side == 0 && game->raydiry > 0)
